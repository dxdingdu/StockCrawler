...
public class StockPageProcessor implements PageProcessor {
    ...
    public void process(Page page) {
        ...
        String stockCode = stockInfo.substring(stockInfo.indexOf('(') + 1, stockInfo.length() - 1);
        String stockDate = page.getHtml().$("div.left.con-br").xpath("tidyText()").toString().substring(0, 10);
        String closingPrice = page.getHtml().$("div.data-tips")
        Selectable table = page.getHtml().$(".default_tab stock-detail-tab").nodes().get(0);
